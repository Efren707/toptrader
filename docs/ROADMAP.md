...
> Last updated: 2026-07-28 (Milestone #12 UI/UX Polish Pass fully scoped: US-10 through US-14; US-10 done, merged via PR #41; issues #34/#35/#37/#39 open)
...
1. **US-10 — Navigate between auth pages, and log out** — ✅ done, issue [#31](https://github.com/Efren707/toptrader/issues/31), merged via PR [#41](https://github.com/Efren707/toptrader/pull/41). Login/register cross-links, navbar logo → dashboard, logout wiring (frontend `AuthService.logout()` + backend `POST /auth/logout` fix). **Next step: implement US-11.**
