...
MVP (US-1–US-9), the UI/UX polish pass, pre-deployment hardening, the **[AWS Deployment Infrastructure milestone](https://github.com/Efren707/toptrader/milestone/14)** (10 sections plus hardening issues #102/#105), and the **[Demo Account & Showcase Readiness milestone](https://github.com/Efren707/toptrader/milestone/15)** (one-click, read-only "Try Demo" login plus README/showcase polish) are all done and closed. TopTrader is live at `app.toptrader.dev` on a fully provisioned, observed (CloudWatch/SNS), and self-healing (automated jar rollback) AWS deploy pipeline, with a shareable read-only demo account for reviewers — full detail archived at [docs/tasks/completed/aws-infrastructure-implementation.md](./tasks/completed/aws-infrastructure-implementation.md) and [docs/tasks/completed/demo-account.md](./tasks/completed/demo-account.md). **Current focus**: none picked yet — candidates scoped in [docs/tasks/planning/](./tasks/planning/) (friends, leaderboard, skeleton loading, stock price chart, user profile management).
